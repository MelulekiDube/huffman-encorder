...
${OBJECTDIR}/HuffmanEncoding.o: HuffmanEncoding.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HuffmanEncoding.o HuffmanEncoding.cpp

${OBJECTDIR}/HuffmanNode.o: HuffmanNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HuffmanNode.o HuffmanNode.cpp

${OBJECTDIR}/HuffmanTree.o: HuffmanTree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HuffmanTree.o HuffmanTree.cpp

${OBJECTDIR}/Testing.o: Testing.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Testing.o Testing.cpp
